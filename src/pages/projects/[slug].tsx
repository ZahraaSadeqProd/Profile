...
export default function ProjectPage() {
  ...
  return (
    <main className="px-4 sm:px-6 lg:px-8 py-12 sm:py-16 max-w-4xl mx-auto relative z-10 min-h-screen flex flex-col">
      <div className="flex-grow">
        ...
        <div className="flex flex-col sm:flex-row gap-4 mb-12">
          {project.demoUrl ? (
            ...
            <div className="inline-flex items-center justify-center px-6 py-3 rounded-lg 

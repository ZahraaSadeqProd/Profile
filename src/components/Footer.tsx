export default function Footer() {
  ...
  return (
    <footer className="border-t border-pink-200/50 dark:border-pink-700/30 
                       bg-white dark:bg-[#141219]
                       mt-16">
        ...
        <div className="flex flex-col sm:flex-row justify-between items-center gap-6">
          ...
          <div className="flex items-center gap-2">
            <a
              ...
              className="p-2.5 rounded-lg text-gray-600 dark:text-gray-500

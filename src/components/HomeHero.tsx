    ...
    <section className="py-12 sm:py-16 lg:py-20 relative">
      <div className="max-w-3xl">
        ...
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 dark:text-white mb-4 leading-tight">
          Hi, I&apos;m{" "}
          <span className="text-gradient">Zahraa</span>
        </h1>

        {/* Subtitle */}
        <p className="text-lg sm:text-xl text-gray-700 dark:text-gray-200 mb-3 leading-relaxed font-medium">
          Software Engineer specializing in{" "}
          <span className="text-pink-600 dark:text-pink-400">full-stack development</span>
        </p>

        {/* Description */}
        <p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-8 leading-relaxed max-w-2xl">
          I build modern web applications using Angular, React, Next.js, and Node.js. 
          Passionate about creating elegant solutions and exceptional user experiences.
        </p>
        ...
        <div className="flex gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-3 rounded-lg bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900
